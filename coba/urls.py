...
from .views import CheckInView,acceptCheckForm,checkInWebhook, checkOutWebhook, getAvailableStudents,getStudentId
...
urlpatterns = [
    ...
    path("webhooks/students/",getAvailableStudents,name="availableStudents")
]
